...
The weather source is first in line because it combines a large liquid contract
family with free official point-in-time forecasts and a direct probability
mapping. No structural weather cell qualified in the expanded suite. The
adapter must therefore be pre-registered as a new probability comparison and
must not tune itself against previously selected path results.
